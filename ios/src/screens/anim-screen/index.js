...
class Main extends React.Component {
  ...
  step4TopShifting = () => {
    ...
    console.log('screen 4 top shifting')
  };
  ...
  step5Shifting = () => {
    ...
    console.log('screen 5 top shifting')
     ...
     {screen === '4' && (
       <Btn
         style={{
           ...
           zIndex: 99999, position: 'absolute', bottom: 10
         }}
...
const actionCreators = {
  ...
  filterClearAction: filterActions.filterClearAction,
};
