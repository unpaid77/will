...
import {View, Text, Image, StyleSheet, ImagePropTypes, Platform, TouchableOpacity} from 'react-native';
        ...
        <View style={styles.calendarbg}>
          <ScrollView
            ...
            <View style={styles.topBg}>
              <TouchableOpacity style={styles.arrow} onPress={() => props.navigation.navigate('Home')} >
