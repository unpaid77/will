...
import NotificationMessage from '../PushNotification/NotificationMessage';
...
import myOrderListing from '../../screens/myOrderListing';
import Offers from '../PushNotification/Offers';
import FreshChat from '../freshChat';
import myOrderListingOneDay from '../../screens/myOrderListingOneDay';
...
const DrawerNavigator = (props) => {
  ...
  const getuserType = async () => {
    let tmp = await AsyncStorage.getItem('verify')
    setUserType(tmp);
  };
  ...
  if (props.labelStatus) {
    ...
    return (
      <Drawer.Navigator
        ...
        />
        <Drawer.Screen
          name="myOrderListingOneDay"
          component={myOrderListingOneDay}
          options={{swipeEnabled: false}}
        />
